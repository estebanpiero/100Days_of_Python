...
/______/______/______/______/______/______/______/______/______/______/[Esteban]
*******************************************************************************'
''')
print('')
...
def treasure_island():
    ...
    while choice1 != 'left' and choice1 != 'right':
        choice1 = input('Invalid choice. Please type "left" or "right". Otherwise type "Quit" to exit. ').lower()
        if choice1 == 'quit':
